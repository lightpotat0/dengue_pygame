...
class Player(pygame.sprite.Sprite):
	...
	def __init__(self):
		super().__init__()
		self.images = [
			pygame.image.load('../../../assets/images/minigames/run_from_dengue/runboy1.png').convert_alpha(),
			pygame.image.load('../../../assets/images/minigames/run_from_dengue/runboy2.png').convert_alpha(),
			pygame.image.load('../../../assets/images/minigames/run_from_dengue/runboy3.png').convert_alpha(),
			pygame.image.load('../../../assets/images/minigames/run_from_dengue/runboy4.png').convert_alpha()
		]
		self.speed = 1.0
		self.image_index = 0
...
object_images = {
	'down': pygame.image.load('../../../assets/images/minigames/run_from_dengue/bucketdown.png').convert_alpha(),
	'up': pygame.image.load('../../../assets/images/minigames/run_from_dengue/trashup.png').convert_alpha(),
	'right': pygame.image.load('../../../assets/images/minigames/run_from_dengue/tireright.png').convert_alpha()
}
...
class WalkMinigame:
	...
	def __init__(self):
		...
		# Sprites do Cenário
		self.clouds = pygame.image.load('../../../assets/images/minigames/run_from_dengue/cloudsbackground.png').convert_alpha()
		self.clouds_rect = self.clouds.get_rect(topleft=(0, 0))

		self.background = pygame.image.load('../../../assets/images/minigames/run_from_dengue/background.png').convert_alpha()
		self.background_rect = self.background.get_rect(topleft=(0, 0))

		self.ground = pygame.image.load('../../../assets/images/minigames/run_from_dengue/ground.png').convert_alpha()
		self.ground_rect = self.ground.get_rect(bottomleft=(0, 720))

		# Sprites das Setas
		self.upkey = pygame.image.load("../../../assets/images/minigames/run_from_dengue/upkey.png").convert_alpha()
		self.downkey = pygame.image.load("../../../assets/images/minigames/run_from_dengue/downkey.png").convert_alpha()
		self.rightkey = pygame.image.load("../../../assets/images/minigames/run_from_dengue/rightkey.png").convert_alpha()

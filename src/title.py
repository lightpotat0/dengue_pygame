...
#fontes
fonte = pygame.font.Font("../assets/fonts/tt-milks-casual-pie-base.ttf", 30)
fonte1 = pygame.font.Font("../assets/fonts/tt-milks-casual-pie-base.ttf", 25)
class Titulo:
	def __init__(self):
		self.logo = pygame.image.load("../assets/images/ui/logo/logo.png").convert_alpha()
		self.bg = pygame.image.load("../assets/images/ui/logo/titulobq.png").convert_alpha()
		self.comecar = False

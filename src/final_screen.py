...
font48 = pygame.font.Font("../assets/fonts/tt-milks-casual-pie-base.ttf", 48)
font64 = pygame.font.Font("../assets/fonts/tt-milks-casual-pie-base.ttf", 64)
...
class FinalTela:
	...
	def __init__(self, numero, personagem):
		...
		self.personagens = [
			pygame.image.load("../assets/images/characters/players/walk_sprites/characterswalk1.png").convert_alpha(),
			pygame.image.load("../assets/images/characters/players/walk_sprites/characterswalk2.png").convert_alpha(),
			pygame.image.load("../assets/images/characters/players/walk_sprites/characterswalk3.png").convert_alpha(),
			pygame.image.load("../assets/images/characters/players/walk_sprites/characterswalk4.png").convert_alpha()
		]
		...
		self.font = pygame.font.Font("../assets/fonts/tt-milks-casual-pie-base.ttf", 50)

...
class Selecion:
	def __init__(self, casas, jogo):
		...
		self.jogadores = 0
		self.fundo = pygame.image.load("../assets/images/ui/tela_de_selecao/fundo.png").convert_alpha()
		self.portratos = [
			pygame.image.load("../assets/images/characters/players/FullArtPlayer_2.png").convert_alpha(),
			pygame.image.load("../assets/images/characters/players/FullArtPlayer_4.png").convert_alpha(),
			pygame.image.load("../assets/images/characters/players/FullArtPlayer_1.png").convert_alpha(),
			pygame.image.load("../assets/images/characters/players/FullArtPlayer_3.png").convert_alpha()
		]
		self.ninguem = pygame.Surface((200, 300))
		self.start = pygame.image.load("../assets/images/ui/tela_de_selecao/start.png").convert_alpha()

		self.number1 = pygame.image.load("../assets/images/ui/tela_de_selecao/1.png").convert_alpha()
		self.number2 = pygame.image.load("../assets/images/ui/tela_de_selecao/2.png").convert_alpha()
		self.number3 = pygame.image.load("../assets/images/ui/tela_de_selecao/3.png").convert_alpha()
		self.number4 = pygame.image.load("../assets/images/ui/tela_de_selecao/4.png").convert_alpha()

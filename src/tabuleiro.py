...
fundo = pygame.image.load("../assets/images/board_game/casas/chao_mapa.png").convert_alpha()
objetos = [
	pygame.image.load("../assets/images/board_game/camadas_obj_mapa/mapa_objetos_0.png").convert_alpha(),
	pygame.image.load("../assets/images/board_game/camadas_obj_mapa/mapa_objetos_1.png").convert_alpha(),
	pygame.image.load("../assets/images/board_game/camadas_obj_mapa/mapa_objetos_2.png").convert_alpha(),
	pygame.image.load("../assets/images/board_game/camadas_obj_mapa/mapa_objetos_3.png").convert_alpha(),
	pygame.image.load("../assets/images/board_game/camadas_obj_mapa/mapa_objetos_4.png").convert_alpha()
]
portal = pygame.transform.smoothscale(pygame.image.load(
	"../assets/images/board_game/casas/casa_portal.png").convert_alpha(), (256, 256))
cinero = pygame.transform.smoothscale(pygame.image.load(
	"../assets/images/board_game/casas/casa_+5Moedas.png").convert_alpha(), (256, 256))
lixo = pygame.transform.smoothscale(pygame.image.load(
	"../assets/images/board_game/casas/casa_-3Moedas.png").convert_alpha(), (256, 256))
dado = pygame.transform.smoothscale(pygame.image.load(
	"../assets/images/board_game/casas/casa_+dado.png").convert_alpha(), (256, 256))
minigame = pygame.transform.smoothscale(pygame.image.load(
	"../assets/images/board_game/casas/casa_minigame.png").convert_alpha(), (256, 256))
medalha = pygame.transform.smoothscale(pygame.image.load(
	"../assets/images/board_game/casas/casa_medalha.png").convert_alpha(), (256, 256))
medalhas = pygame.transform.smoothscale(pygame.image.load(
	"../assets/images/ui/cartao_personagens/medalha.png").convert_alpha(), (160, 160))
carta = pygame.transform.smoothscale(pygame.image.load(
	"../assets/images/board_game/casas/casa_carta.png").convert_alpha(), (256, 256))
cartabg = pygame.image.load("../assets/images/ui/carta/cartabg.png").convert_alpha()
sombra = pygame.transform.smoothscale(pygame.image.load(
	"../assets/images/board_game/sombra_das_casas.png").convert_alpha(), (320, 320))
interrogacao = pygame.transform.smoothscale(pygame.image.load(
	"../assets/images/ui/carta/pergunta.webp").convert_alpha(), (160, 160))
seta = pygame.image.load("../assets/images/board_game/seta.png").convert_alpha()
moedinha = pygame.transform.smoothscale_by(pygame.image.load(
	"../assets/images/ui/cartao_personagens/moeda.png").convert_alpha(), 0.1)
fonte = pygame.font.Font("../assets/fonts/PressStart2P-Regular.ttf", 50)
fonte_big = pygame.font.Font("../assets/fonts/PressStart2P-Regular.ttf", 64)
...
dadobgs = [
	pygame.transform.smoothscale(pygame.image.load(
		"../assets/images/ui/cartao_personagens/dados/dado_vermelho.png").convert_alpha(), (DADO_SIZE, DADO_SIZE)),
	pygame.transform.smoothscale(pygame.image.load(
		"../assets/images/ui/cartao_personagens/dados/dado_azul.png").convert_alpha(), (DADO_SIZE, DADO_SIZE)),
	pygame.transform.smoothscale(pygame.image.load(
		"../assets/images/ui/cartao_personagens/dados/dado_verde.png").convert_alpha(), (DADO_SIZE, DADO_SIZE)),
	pygame.transform.smoothscale(pygame.image.load(
		"../assets/images/ui/cartao_personagens/dados/dado_amarelo.png").convert_alpha(), (DADO_SIZE, DADO_SIZE))
]
barras = [
	pygame.transform.smoothscale_by(pygame.image.load(
		"../assets/images/ui/cartao_personagens/barra_medalha/barra.png").convert_alpha(), 0.25),
	pygame.transform.smoothscale_by(pygame.image.load(
		"../assets/images/ui/cartao_personagens/barra_medalha/barra1.png").convert_alpha(), 0.25),
	pygame.transform.smoothscale_by(pygame.image.load(
		"../assets/images/ui/cartao_personagens/barra_medalha/barra2.png").convert_alpha(), 0.25),
	pygame.transform.smoothscale_by(pygame.image.load(
		"../assets/images/ui/cartao_personagens/barra_medalha/barra3.png").convert_alpha(), 0.25),
	pygame.transform.smoothscale_by(pygame.image.load(
		"../assets/images/ui/cartao_personagens/barra_medalha/barra4.png").convert_alpha(), 0.25),
	pygame.transform.smoothscale_by(pygame.image.load(
		"../assets/images/ui/cartao_personagens/barra_medalha/barra5.png").convert_alpha(), 0.25)
]
	...
	def frame(self, screen, delta, jogo):
		...
		match self.modo:
			...
			case "camera":
				...
				self.cam_movida = (
				util.clamp(self.cam_movida[0] + movimento[0], 1066 / 2, fundo.get_width() - 1960 * virtual_width / 1066), util.clamp(self.cam_movida[1] + movimento[1], 600 / 2, fundo.get_height() - 1620))
